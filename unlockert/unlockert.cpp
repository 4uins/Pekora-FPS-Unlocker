...
int main()
{
    std::cout << "made by @exterminate\n\n";


    std::cout << "client -  Type 17 for 2017 or 17+ for later: ";
    ...
    if (input == "17")
    {
        std::cout << "\nSorry doesnt work for 2017 atm.\n";
        return 0;
    }
    ...
    while (true)
    {
        ...
        while (!pid)
        {
            pid = FindProcessId(L"RobloxPlayerBeta.exe");
            Sleep(1000);
        }

        std::cout << "Client found! PID: " << pid << std::endl;
